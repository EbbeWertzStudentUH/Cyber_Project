...
import threading
from dacite import to_dict
from pydantic_core import from_json, to_json
from straight_line.command_types import MovementCommand, PanicResponse, MoveArriveResponse, PickupResponse, \
...
def on_message(client, userdata, msg):
    ...
    match topic:
        case "robots/move":
            move = to_dict(MovementCommand, payload_dict)
        ...
        case "robots/pickup":
            arrive = to_dict(PickupCommand, payload_dict)
            startTime = robot.getTime()
            pickup()
        ...
        case "robots/frop_off":
            pickup = to_dict(PickupResponse, payload_dict)
            startTime = robot.getTime()
            drop_off()
